...
const shareImagePath = '/images/og.jpg?v=3'
...
export const wedding = {
  ...
  greeting: `오랜 시간 동안 서로의 곁을 지키며 깨달았습니다.
...
하나님 앞에서 맺는 언약의 증인이 되어주세요.`,
  ...
  accounts: [
    ...
    { name: '김세연', role: '신부', bank: '카카오뱅크', number: '3333-21-6386885', phone: '010-8338-6028' },
